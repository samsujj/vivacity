		...
		<fieldset class="te">
			...
			<dl class="te">
				...
				<dt class="te <?php echo $this->get_field_type( 'requires_success_line' ); ?> requires_success_line" >
					<?php $this->draw_input_field( 'requires_success_line', $this->db['requires_success_line'], 'edit', 'requires_success_line' ); ?><label class="te <?php echo $this->get_field_type( 'requires_success_line' ); ?> requires_success_line" for="requires_success_line">Requires Success Line</label> <small>(Do not display if user is not in success line)</small>
				</dt>
				...
				<dt class="te <?php echo $this->get_field_type( 'is_public' ); ?> is_public" >
					<?php $this->draw_input_field( 'is_public', $this->db['is_public'], 'edit', 'is_public' ); ?><label class="te <?php echo $this->get_field_type( 'is_public' ); ?> is_public" for="is_public">Is Public?<small>(Should Non-Webdev see this entry)</small>
				</dt>
