...
if(isset($_SESSION['awaken-and-revive-promoter'])){
    $orderid = $_SESSION['awaken-and-revive-promoter']['created_order'];
    unset($_SESSION['awaken-and-revive-promoter']);
}else if(isset($_SESSION['awaken-and-revive-affiliate'])){
    $orderid = $_SESSION['awaken-and-revive-affiliate']['created_order'];
    unset($_SESSION['awaken-and-revive-affiliate']);
}else if(isset($_SESSION['awaken-cbd-affiliate'])){
    $orderid = $_SESSION['awaken-cbd-affiliate']['created_order'];
    unset($_SESSION['awaken-cbd-affiliate']);
}else{
    util_redirect('/');
}
